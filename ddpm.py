...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % 10 == 0:
            ...
            # ema
            sampled_images_ema = diffusion.sample(ema_model, n=images.shape[0])
...
def launch():
    ...
    #args.dataset_path = r"/home/mwallrodt/Desktop/mnielsen/Desktop/Masterarbeit_MWallrodt/Code/DDPM/landscapes_dataset"
    args.device = "cuda"
    args.lr = 2e-4
    train(args)
